...
const SITE_STATUS_STEPS = [
  { key: 'PENDING_STORE', label: 'Approved by Store' },
  { key: 'ALLOCATED', label: 'Approved by Store' },
  { key: 'FORWARDED_TO_PM', label: 'Approved by PM' },
  { key: 'BRANCH_TRANSFER_REQUESTED', label: 'Approved by PM' },
  { key: 'PENDING_HO', label: 'Approved by Executive' },
  { key: 'PENDING_EXECUTIVE_DECISION', label: 'Approved by Executive' },
  { key: 'EXECUTIVE_DECISION_PO', label: 'Approved by Coordinator' },
  { key: 'EXECUTIVE_DECISION_BRANCH_TRANSFER', label: 'Approved by Coordinator' },
  { key: 'PM_APPROVED', label: 'Approved by Store' },
  { key: 'PURCHASE_REQUESTED', label: 'Approved by Executive' },
  { key: 'PO_CREATED', label: 'PO created' },
  { key: 'COORDINATOR_VERIFIED', label: 'Approved by Chairman' },
  { key: 'CHAIRMAN_APPROVED', label: 'Approved by Store' },
